...
Four interfaces over one dataset:
...
* ``python -m st_cheatsheet verify`` - execute every example against a live PostGIS and
  check that it still produces the result the dataset claims.
